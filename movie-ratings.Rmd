...
Values of the key dependent variable, ratings, in edx are discrete. In other words ratings values are measured by counting. One improvement in my model is that it will allow for ratings predictions that are discrete. The result should be a more sensitive measure and, by extension, a lower RMSE.
...
# Check for NAs in validation set
...
# Convert NAs to mean of b_t in validation
