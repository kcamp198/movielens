...
Additional summary detail on the edx set is included in table 1.2.  
...
Another useful bit of information is the timing of when users submitted ratings. The rating submission dates in the edx set range from 1995 to 2009, as illustrated in table 1.3.  
